    ...
    <!--start-image-slider---->
        ...
        <form action="loginaction.php" method="post">
          ...
          <fieldset class="text-center" style="padding: 10px 20px; width:50%;margin:auto;">
            <legend style="font-size:1.2em; color:#94CB32;">Log In here</legend>
            <label for="" style="font-family: 'Open Sans', sans-serif;color: #399649;">Log in as:<br><br></label>
              <input type="radio" name="person" value="admin" checked style="color:#94CB32;">Admin<br>
              <input type="radio" name="person" value="user" style="color:#94CB32;">User<br><br>
          ...
          <br><br>
          <a href="forgotpass.php">Forget Your Password???<br><br></a>
          <button type="submit" style="color:#399649;">Log In</button>
          <br><br>
                <a href="home.php">Go Home<br><br></a>
