    ...
    <!--start-image-slider---->
		...
		<form action="resetaction.php" method="post">
			...
			<fieldset class="text-center" style="padding: 10px 20px; width:50%;margin:auto;">
				<legend style="font-size:1.2em; color:green;">Reset Password</legend>
			<h3 style="font-family: 'Open Sans', sans-serif;color: #94CB32;">Reset Your Password Here</h3>
			<label style="font-family: 'Open Sans', sans-serif;color: #399649;">Enter new Password:<br><br></label>
			<input type="password" name ="pass"><br><br>
			<label style="font-family: 'Open Sans', sans-serif;color: #399649;">Confirm new Password:<br><br></label>
			<input type="password" name ="repass"><br><br>
			<input type="submit" value="Reset Password" style="color:#399649;">
			</fieldset>
			<br><br><br>
		</form>
