...
<html>
    ...
    <!--start-image-slider---->
            ...
            <div class="content-grids">
                <h4 class="text-center" style="padding:30px 30px 30px 70px;">Category :<?php echo $_SESSION['category'] ?></h4>
