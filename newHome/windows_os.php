...
if(!isset($_SESSION['user']))
{
	...
	$arr = $db->getCategorizedData("app_os","Windows");
...
<html>
    ...
    <!--start-image-slider---->
            ...
            <div class="content-grids">
                <img style="display: block; margin-top:10px; margin-left:auto; margin-right:auto;" src="images/windows.png">
                <h4 class="text-center" style="padding:10px 30px 30px 30px;">Windows Apps</h4>
